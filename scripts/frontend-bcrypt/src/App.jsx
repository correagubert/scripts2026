...
export default function RappaUI() {
  ...
  const [formConsulta, setFormConsulta] = useState({ id: null, nome: '', categoria: '', sku: '', status: 'Ativo', estoque: 0, preco: '' });
  ...
  const abrirModalConsulta = (consulta = null) => {
    ...
    else setFormConsulta({ id: null, nome: '', categoria: '', sku: '', status: 'Ativo', estoque: 0, preco: '' });
        ...
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-[#121212] border border-neutral-800 w-full max-w-md rounded-xl p-6 shadow-2xl">
            ...
            <form onSubmit={salvarConsulta} className="space-y-4">
              <div>
                <label className="text-xs text-neutral-500 mb-1 block">Nome do Consulta</label>
              ...
              <div className="flex gap-4">
                <div className="w-1/2">
                  ...
                  <input type="text" value={formConsulta.categoria} onChange={e => setFormConsulta({...formConsulta, categoria: e.target.value})} className="w-full bg-neutral-900 border border-neutral-800 rounded py-2.5 px-3 text-sm text-white focus:outline-none focus:border-neutral-600 transition-colors" required />
                </div>
                <div className="w-1/2">
                  <label className="text-xs text-neutral-500 mb-1 block">SKU</label>
                  <input type="text" value={formConsulta.sku} onChange={e => setFormConsulta({...formConsulta, sku: e.target.value})} className="w-full bg-neutral-900 border border-neutral-800 rounded py-2.5 px-3 text-sm text-white focus:outline-none focus:border-neutral-600 transition-colors" required />
                </div>
              </div>
              <div className="flex gap-4">
                <div className="w-1/3">
                ...
                <div className="w-1/3">
                  ...
                  <input type="number" value={formConsulta.estoque} onChange={e => setFormConsulta({...formConsulta, estoque: e.target.value})} className="w-full bg-neutral-900 border border-neutral-800 rounded py-2.5 px-3 text-sm text-white focus:outline-none focus:border-neutral-600 transition-colors" required />
                </div>
                <div className="w-1/3">
